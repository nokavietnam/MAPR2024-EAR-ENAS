...
def main(noise, dataset) -> None:
    ...
    p.dump(data_result, open(f'data/robustness-data/result/data_{noise}_{dataset}_acc.p', 'wb'))


if __name__ == '__main__':
    main(noise='fgsm', dataset='cifar10')